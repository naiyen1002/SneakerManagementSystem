 ...
 */
public class Sale extends SSdetails {
     ...
     * 
     * @param salesId The unique identifier for this sale (must be 4 characters)
     * @param memberId The member ID associated with this sale (must be 4 characters)
     ...
     */
    public Sale(String salesId, String memberId, String itemCode, String itemBrand, 
