...
// static {
// salesDetails.add(new SalesItem("S001", "M101", "I001", "NIKE", "First Running
// Shoes", "Black", 79.98, 1));
// salesDetails.add(new SalesItem("S002", "M102", "I002", "PUMA", "Athletic
// Sneakers", "White", 89.99, 9));
// salesDetails.add(new SalesItem("S003", "M103", "I003", "ADIDAS", "Casual
// Sneakers", "Grey", 99.97, 3));
// salesDetails.add(new SalesItem("S004", "M104", "I004", "PUMA", "Athletic
// Sneakers", "White", 89.49, 7));
// salesDetails.add(new SalesItem("S005", "M105", "I005", "PUMA", "Athletic
// Sneakers", "White", 89.79, 5));
// }
...
// }
// default -> {
// System.out.println("Invalid input. Please enter a number between 0 to 6
// only.\n");
...
// System.out.println("+========+=========+=========+=========+=============================+==========+==============+=========+");
// System.out.println("|SALES ID|MEMBER ID|ITEM CODE| BRAND | ITEM DESCRIPTION |
// COLOUR |ITEM PRICE(RM)|QTY SALES|");
// System.out.println("+========+=========+=========+=========+=============================+==========+==============+=========+");

// int count = 0;
// for (SalesItem item : salesDetails) {
// System.out.printf("| %-6s| %-7s| %-7s|%-9s|%-29s|%-10s|%14.2f|%9d|%n",
// item.getSalesId(), item.getMemberId(), item.getItemCode(), item.getBrand(),
// item.getItemDescription(), item.getColour(), item.getItemPrice(),
...
// if (salesId.length() != 4) {
// System.out.println("Invalid sales id length. Please enter exactly 4
// characters.");
// isDuplicate = true;
// } else {
// for (SalesItem item : salesDetails) {
// if (item.getSalesId().equals(salesId)) {
// System.out.println("Sales id already exists. Please enter a unique sales
// id.");
// isDuplicate = true;
// break;
// }
...
// System.out.println("Invalid member id length. Please enter exactly 4
// characters.");
// isDuplicate = true;
// } else {
// for (SalesItem item : salesDetails) {
// if (item.getMemberId().equals(memberId)) {
// System.out.println("Member id already exists. Please enter a unique member
// id.");
// isDuplicate = true;
// break;
// }
...
// System.out.println("Invalid item code length. Please enter exactly 4
// characters.");
// isDuplicate = true;
// } else {
...
// System.out.println("Item code already exists. Please enter a unique item
// code.");
// isDuplicate = true;
// break;
// }
...
// System.out.println("Brand name is too long. Please enter below 9
// characters.");
// isDuplicate = true;
...
// System.out.println("Item description is too long. Please enter below 30
// characters.");
// isDuplicate = true;
...
// System.out.println("Color name is too long. Please enter below 6
// characters.");
// isDuplicate = true;
// //colorChoice=5;
...
// System.out.println("Item price exceeds the maximum allowed amount of
// RM999999999.99.");
// }
...
// do {
// System.out.println("\n\nDo you suare want to add this new sales information?
// (Y/N): ");
// yesNo = scanner.next().charAt(0);
// if (yesNo != 'y' && yesNo != 'Y' && yesNo != 'n' && yesNo != 'N') {
// System.out.println("Enter y, Y, n, or N only!!!");
// } else if (yesNo == 'y' || yesNo == 'Y') {
// SalesItem item = new SalesItem(salesId, memberId, itemCode, itemBrand,
// itemDescription, itemColor, itemPrice, quantitySales);
...
// System.out.println("\nSales ID with " + SalesIdToDelete + " has been
// deleted.");
// count++;
// } else {
// System.out.println("\n\nDeletion canceled.");
...
// System.out.println("\nInvalid sales id length. Please enter exactly 4
// characters.");
// isDuplicate = true;
// } else {
// for (SalesItem item : salesDetails) {
// if (item.getSalesId().equals(newSalesId)) {
// System.out.println("\nSales id already exists. Please enter a unique sales
// id.");
// isDuplicate = true;
// break;
// }
...
// System.out.println("\nInvalid member id length. Please enter exactly 4
// characters.");
// isDuplicate = true;
// } else {
// for (SalesItem item : salesDetails) {
// if (item.getMemberId().equals(newMemberId)) {
// System.out.println("\nMember id already exists. Please enter a unique member
// id.");
// isDuplicate = true;
// break;
// }
...
// System.out.println("\nInvalid item code length. Please enter exactly 4
// characters.");
// isDuplicate = true;
// } else {
// for (SalesItem item : salesDetails) {
// if (item.getItemCode().equals(newItemCode)) {
// System.out.println("\nItem code already exists. Please enter a unique item
// code.");
// isDuplicate = true;
// break;
// }
...
// System.out.println("\nNew brand name is too long. Please enter below 9
// characters.");
// isDuplicate = true;
...
// System.out.println("New item description is too long. Please enter below 30
// characters.");
// isDuplicate = true;
...
// System.out.println("\nNew color name is too long. Please enter below 11
// characters.");
// isDuplicate = true;
// //colorChoice=5;
...
// System.out.println("\nItem price exceeds the maximum allowed amount of
// RM999999999.99.");
// }
...
// System.out.println("\nSales ID with " + SalesIdToModify + " has been
// modify.");
// count++;
// } else {
// System.out.println("\n\nModify canceled.");
...
// System.out.println(" 8 -> Search by QUANTITY SALES"); System.out.println(" 0
// -> Exit");
// System.out.println(" --------------------------------------");
// System.out.print(" Enter your choice: ");
...
// System.out.println("\nExiting Search Menu...\n");
// }
// default -> System.out.println("Invalid input. Please enter a number between 0
// to 8 only.\n");
// }
...
// }
// if (found == 0) {
// System.out.println("\nDescription with " + descriptionToSearch + " not
// found.");
// }
// }
...
// if (found == 0) {
// System.out.println("\nItem Price with RM" + itemPriceToSearch + " not
// found.");
// }
// }
...
// if (found == 0) {
// System.out.println("\nQuantity Sales with " + quantitySalesToSearch + " not
// found.");
// }
// }
// }